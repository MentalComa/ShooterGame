...
public class ColoringWeapon : MonoBehaviour
{
  ...
  //  void Start()
   // {
     ...
     //   StuffBall = Ball.GetComponent<Renderer>();
     //   StuffBall.material.color = newColor;
   ...
   // {
    //    if (!collision.gameObject.CompareTag("Terrain") && !collision.gameObject.CompareTag("Player") && !collision.gameObject.CompareTag("Enemy") && !collision.gameObject.CompareTag("Bullet") && !collision.gameObject.CompareTag("NoPainting") )
    //    {
     //       collision.gameObject.GetComponent<Renderer>().material.color = StuffBall.material.color;
